...
// The backend sends a `label` with every tool event; prefer it so a tool added
// server-side reads correctly here without a frontend change.
...
const CODE_ARG_KEYS = { execute: new Set(["code"]), run_query: new Set(["sql"]) };
