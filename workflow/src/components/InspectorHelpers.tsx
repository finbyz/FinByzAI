...
export const nodeLabels: Record<NodeType, string> = {
  ...
  'action.ai_generate': 'Understand with AI',
  'action.ai_support_agent': 'Run AI support agent',
  'action.human_approval': 'Request human approval',
...
export const nodeIcons: Record<NodeType, typeof Play> = {
  ...
  'action.ai_generate': Sparkles,
  'action.ai_support_agent': Sparkles,
  'action.human_approval': CheckCircle2,
