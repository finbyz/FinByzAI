...
NODE_CATALOG = [
	...
	{"type": "action.ai_generate", "type_version": 1, "label": "Understand with AI", "category": "AI", "description": "Summarize, classify, extract, draft, or answer from approved knowledge without changing the record.", "default_config": {"mode": "summarize", "ai_profile": "", "knowledge_base": "", "field_allowlist": [], "include_thread": 0, "thread_limit": 10, "instructions": "", "confidence_threshold": 0.75, "timeout_seconds": 60, "max_tokens": 1024, "failure_mode": "branch"}},
...
NODE_AUTHORING_SCHEMAS = {
	...
	"action.ai_generate": {"required": [{"path": "mode", "label": "AI task"}, {"path": "ai_profile", "label": "AI Agent"}, {"path": "field_allowlist", "label": "Permitted context fields"}]},
